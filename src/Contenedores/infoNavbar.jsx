...
import Robot from "./Robot"; // Importa el componente Robot

export default function InfoNavbar({ toggleAbout }) {
  const toggleOptions = () => {
    // Llama a toggleOptions de Robot cuando se hace clic en el enlace de contacto
    Robot.toggleOptions();
  };
  ...
  return (
    <div className="flex justify-between items-center bg-[#191919] text-[#A7A7A7] w-full pt-[2%] max-sm:bg-[#191919] sm:bg-[#191919] md:bg-[#191919] lg:bg-[#191919] ">
      ...
      <div className="flex w-[98%] gap-[5%] text-[18px] items-center justify-center ">
        ...
        <a
          href="#"
          onClick={toggleOptions} // Llama a toggleOptions al hacer clic en Contact
      ...
      <div className="flex gap-[12%] pr-[10%] max-sm:h-[28px] max-sm:pr-[13%] ">
        <a href="https://github.com/Alan-Britoo" target="_blank">
          {/* GITHUB ICON */}
          <svg
